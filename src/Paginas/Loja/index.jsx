...
export default function Loja(){
    ...
    return(
        ...
        <div className='flex flex-col
            ...
            <div className='flex justify-center items-center text-white border-[#F4CD00] rounded-2xl
                            border-[2px] w-[25%] h-[6.5vh]
                            md:w-[13%] md:text-[20px]
                            lg:h-[8vh] lg:w-[9vw] lg:text-[2vw] lg:border-[3px]'>
                <span className='text-[#F4CD00] material-symbols-outlined
                                    lg:text-[100%] lg:mr-1'>paid</span>
                {moedas}
            </div>
            <div className='flex flex-col mt-4'>
                    <h2 className="text-white pb-1 border-[#d6d5d5] 
                                    border-b-2 text-[19px] pl-2
                                    md:mt-3">PACOTES DE FIGURINHAS</h2>
                    ...
                    <h2 className="text-white pb-1 border-[#d6d5d5] 
                                    border-b-2 text-[19px] pl-2 mt-[10vh]">SEÇÃO ESPECIAL</h2>
                    ...
                    <h2 className="text-white pb-1 border-[#d6d5d5] 
                                    border-b-2 text-[19px] pl-2 mt-[10vh]">NOVIDADES</h2>
                    <div className="grid gap-5
                                    grid-col-1 
                                    sm:grid-cols-2 
                                    md:grid-cols-3 
                    ...
                    <h2 className="text-white pb-1 border-[#d6d5d5] 
                                    border-b-2 text-[19px] pl-2 mt-[10vh]">PROMOÇÃO</h2>
                    <div className="grid gap-5
                                    grid-col-1 
                                    sm:grid-cols-2 
                                    md:grid-cols-3 

...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 px-8 bg-black pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-5 w-full flex flex-col lg:flex-col lg:w-full md:flex-row md:items-center md:gap-5 md:w-[100vh]">
                ...
                <h3 className="text-white text-5xl font-modak font-light">E-TEEN</h3>
